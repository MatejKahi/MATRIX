...
public class Shaders {
    private static final String vertexShaderSource = FileUtils.readFile("resources/shader-uniforms/shaders/vertex-shader.glsl");

    private static final String fragmentShaderSource = FileUtils.readFile("resources/shader-uniforms/shaders/fragment-shader.glsl");
